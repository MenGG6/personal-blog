...
class LexinSport:
    ...
    def change_step(self):
        ...
        if login_result == '登录失败':
            ...
            if status_code == 200:
                return self.username + '修改步数为【%s】成功\n' % self.step
            else:
                return self.username + '修改步数失败\n'
    ...
    while 1:
        while fail_num > 0:
            try:
                ...
                #18931141493
                #llf123
                result1 = LexinSport('17862005251', 'lm1314lm', 99999).change_step()
                result2 = LexinSport('18931141493', 'llf123', 99999).change_step()
                result3 = LexinSport('18669657579', '11223344', 99999).change_step()
